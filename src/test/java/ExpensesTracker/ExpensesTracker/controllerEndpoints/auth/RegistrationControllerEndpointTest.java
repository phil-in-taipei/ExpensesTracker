...
public class RegistrationControllerEndpointTest {
    ...
    public void showRegisterForm() throws Exception {
        mockMvc
                ...
                .andExpect(model().attributeExists("userRegistrationForm"))
    ...
    // this will attempt to register a new user and
    // should succeed, the user here will be deleted each time
    // tests are run via the ExpensesTrackerApplicationTest command line runner
    @Test
    @Order(4)
    @Transactional
